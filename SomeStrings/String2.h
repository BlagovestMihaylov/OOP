...
class String
{
  public:
    ...
    friend const String operator+(const String &lhs, const String &rhs); // s = s1 + s2
    friend const String operator+(const String &lhs, const char *str); // s = s1 + "hello"
    friend const String operator+(const char *str, const String &rhs); // s = "hello" + s1
